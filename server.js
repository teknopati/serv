...
// Performans ve donmaları bitirmek için listeleri bellekte tutuyoruz
let cacheTV = [];
let cacheMovies = [];
let cacheSeries = [];
...
app.get('/player_api.php', (req, res) => {
    ...
    // CANLI KANALLAR (Donmayı önleyen güvenli akış)
    ...
    // DİZİLER (Series - Orijinal yapısı tamamen korundu)
