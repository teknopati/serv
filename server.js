...
// =========================================================
// İSTERSEN AŞAĞIDAKİ KULLANICI ADI VE ŞİFREYİ DEĞİŞTİREBİLİRSİN
// =========================================================
const USERNAME = "admin";
const PASSWORD = "123";

// M3U Dosyasını Okuma ve İşleme Fonksiyonu
function parseM3U() {
    try {
...
// Xtream API Giriş ve Bilgi İsteği
app.get('/player_api.php', (req, res) => {
    ...
    // Uygulama Giriş Yaparken Kullanıcı Bilgisi İsterse:
    if (!action) {
        return res.json({
            user_info: {
                username: USERNAME,
...
// Oynatıcı Linke Bastığında Gerçek Yayına Yönlendirme
app.get('/:type/:user/:pass/:id', (req, res) => {
    ...
    const cleanId = parseInt(id.replace(/\.[^/.]+$/, "")); // Uzantıyı temizle (.m3u8 veya .ts)
